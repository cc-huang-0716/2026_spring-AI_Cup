...
def run_pipeline(args: argparse.Namespace) -> None:
    ...
    if args.ag_time_limit is None:
        print("[AG] no global time_limit: every requested AutoGluon model will be attempted unless it fails due to dependencies/resources.")
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--no_time_limit", action="store_true", help="Do not pass time_limit to AutoGluon; every requested model gets a chance to run.")
    ...
    args = p.parse_args()
    if args.no_time_limit or args.ag_time_limit <= 0:
        args.ag_time_limit = None
